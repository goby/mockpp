...
pkgdatadir = $(datadir)/mockpp
pkglibdir = $(libdir)/mockpp
pkgincludedir = $(includedir)/mockpp
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/mockpp.doxygen.in $(srcdir)/mockpp.pc.in \
	$(srcdir)/mockpp.spec.in $(top_srcdir)/configure AUTHORS \
...
CONFIG_CLEAN_FILES = mockpp.spec mockpp.doxygen mockpp.pc
SOURCES =
DIST_SOURCES =
...
ACLOCAL = ${SHELL} /home/darwin/software/mockpp-revised/revised-mockpp/config/missing --run aclocal-1.10
AMTAR = ${SHELL} /home/darwin/software/mockpp-revised/revised-mockpp/config/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/darwin/software/mockpp-revised/revised-mockpp/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/darwin/software/mockpp-revised/revised-mockpp/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/darwin/software/mockpp-revised/revised-mockpp/config/missing --run automake-1.10
AWK = gawk
BZIP2 = /bin/bzip2
CC = gcc
...
EA_EXTRA_INC =  -I$(top_srcdir)/3party/cxxtest
EA_EXTRA_LIB = 
EA_PDF_CATALOG = 
ECHO = echo
ECHO_C = 
...
LT_RELEASE = 1.16
LT_REVISION = 0
MAKEINFO = ${SHELL} /home/darwin/software/mockpp-revised/revised-mockpp/config/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
MOCKPP_BINARY_AGE = 7
...
MOCKPP_NO_STD_NS = 
MOCKPP_NO_STD_NUMERICLIMITS = 
MOCKPP_VERSION = 1.16.4
MOCKPP_VERSION_NUMBER = 0x00011004
...
ZIPPER = bzip2
ZIPPER_EXT = bz2
abs_builddir = /home/darwin/software/mockpp-revised/revised-mockpp
abs_srcdir = /home/darwin/software/mockpp-revised/revised-mockpp
abs_top_builddir = /home/darwin/software/mockpp-revised/revised-mockpp
abs_top_srcdir = /home/darwin/software/mockpp-revised/revised-mockpp
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_F77 = 
all_includes = 
...
install_sh = $(SHELL) /home/darwin/software/mockpp-revised/revised-mockpp/config/install-sh
...
mockpp.spec: $(top_builddir)/config.status $(srcdir)/mockpp.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
mockpp.doxygen: $(top_builddir)/config.status $(srcdir)/mockpp.doxygen.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
mockpp.pc: $(top_builddir)/config.status $(srcdir)/mockpp.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
