/** @file
 ...
 $Id: CoreMock.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class CoreMock : public AbstractDynamicChainingMock<R, I>
{
  public:
    ...
    typedef typename AbstractDynamicChainingMock<R, I>::ORT ORT;
    typedef typename AbstractDynamicChainingMock<R, I>::RRT RRT;
