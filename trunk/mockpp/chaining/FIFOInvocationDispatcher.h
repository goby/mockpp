/** @file
 ...
 $Id: FIFOInvocationDispatcher.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class FIFOInvocationDispatcher : public AbstractInvocationDispatcher<R, I>
{
  protected:
    ...
    typedef typename AbstractInvocationDispatcher<R, I>::ORT  ORT;
    typedef typename AbstractInvocationDispatcher<R, I>::RRT  RRT;
  ...
  /** Dispatches the invokable
    ...
    */
    virtual RRT dispatch( const I &invocation )
    {
