/** @file
    @brief  Chainable Mock Method with 7 parameters.
            Generated with gen_chainablemethod_N.pl.

  $Id: ChainableMockMethod7.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ChainableMockMethod7_H
#define MOCKPP_ChainableMockMethod7_H
...
/** Common stuff to set up chainable mock method expectations with 7 parameters.
  * @ingroup grp_chainer
  * @internal
  */
template <typename RT, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7>
class ChainableMockMethod7Common
  : public ChainableMockMethodCommon
  , public ChainingMockBuilder <ArgumentsMatchBuilder7<RT, Invocation7<P1, P2, P3, P4, P5, P6, P7> > >
{
  public:

    typedef Invocation7<P1, P2, P3, P4, P5, P6, P7>                InvocationType;  //!< internal shorthand
    ...
    typedef ChainingMockBuilder <ArgumentsMatchBuilder7<ReturnType, InvocationType> > Builder; //!< internal shorthand

  /** Constructs the mock object.
    * @param name    human readable description about the expectation
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod7Common(const String &name, ChainableMockObject *parent )
...
/** Set up a chainable mock method expectations with 7 parameters.
  * @ingroup grp_chainer
  */
template <typename RT, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7>
class ChainableMockMethod7
  : public ChainableMockMethod7Common<RT, P1, P2, P3, P4, P5, P6, P7>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod7Common<RT, P1, P2, P3, P4, P5, P6, P7>::InvocationType   InvocationType;  //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<RT, P1, P2, P3, P4, P5, P6, P7>::RRT   RRT;     //!< internal shorthand

	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT1   OT1;     //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT2   OT2;     //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT3   OT3;     //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT4   OT4;     //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT5   OT5;     //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT6   OT6;     //!< internal shorthand
	 typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::OT7   OT7;     //!< internal shorthand

  /** Constructs the mock object.
    * @param name    human readable description about the expectation
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod7(const String &name, ChainableMockObject *parent )
      : ChainableMockMethod7Common<RT, P1, P2, P3, P4, P5, P6, P7>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    */
    RRT forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4, const OT5 &p5, const OT6 &p6, const OT7 &p7) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4, p5, p6, p7);
      return this->getCoreMock().invoke(inv);
    }

    RT operator () (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7) const
    {
      return forward(p1, p2, p3, p4, p5, p6, p7);
    }

    template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
    typename TypeTraits<R>::RefType anycall(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7) const
    {
      ...
      RRT r = forward(pp1, pp2, pp3, pp4, pp5, pp6, pp7);
...
class ChainableMockMethod7<void, P1, P2, P3, P4, P5, P6, P7>
  : public ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>::InvocationType   InvocationType;  //!< internal shorthand
  ...
  /** Constructs the mock object.
    ...
    */
    ChainableMockMethod7(const String &name, ChainableMockObject *parent )
      : ChainableMockMethod7Common<void, P1, P2, P3, P4, P5, P6, P7>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p7 mock method parameter 7
    */
    void forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4, const OT5 &p5, const OT6 &p6, const OT7 &p7) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4, p5, p6, p7);
    ...
    {
      forward(p1, p2, p3, p4, p5, p6, p7);
    }

    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
    void anycall(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7) const
    {
      const bool outBoundP1 = p1IsAny && IsRef<T1>::outBoundable;
      const bool outBoundP2 = p2IsAny && IsRef<T2>::outBoundable;
      const bool outBoundP3 = p3IsAny && IsRef<T3>::outBoundable;
      ...
      forward(pp1, pp2, pp3, pp4, pp5, pp6, pp7);
...
#endif // MOCKPP_ChainableMockMethod7_H
