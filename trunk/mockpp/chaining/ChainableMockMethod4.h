/** @file
  ...
  $Id: ChainableMockMethod4.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
  ...
  : public ChainableMockMethod4Common<RT, P1, P2, P3, P4>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod4Common<RT, P1, P2, P3, P4>::InvocationType   InvocationType;  //!< internal shorthand
	 typedef typename ChainableMockMethod4Common<RT, P1, P2, P3, P4>::RRT   RRT;     //!< internal shorthand

	 typedef typename ChainableMockMethod4Common<void, P1, P2, P3, P4>::OT1   OT1;     //!< internal shorthand
	 typedef typename ChainableMockMethod4Common<void, P1, P2, P3, P4>::OT2   OT2;     //!< internal shorthand
	 typedef typename ChainableMockMethod4Common<void, P1, P2, P3, P4>::OT3   OT3;     //!< internal shorthand
	 typedef typename ChainableMockMethod4Common<void, P1, P2, P3, P4>::OT4   OT4;     //!< internal shorthand
  ...
  /** Actually verifies the mocked method.
    ...
    */
    RRT forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4) const
    {
	 ...
	 {
		return forward(p1, p2, p3, p4);
	 }

    template <typename R, typename T1, typename T2, typename T3, typename T4>
    typename TypeTraits<R>::RefType anycall(T1 p1, T2 p2, T3 p3, T4 p4) const
    {
  ...
  : public ChainableMockMethod4Common<void, P1, P2, P3, P4>
{
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p4 mock method parameter 4
    */
    void forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4);
    ...
    void anycall(T1 p1, T2 p2, T3 p3, T4 p4) const
    {
      const bool outBoundP1 = p1IsAny && IsRef<T1>::outBoundable;
      const bool outBoundP2 = p2IsAny && IsRef<T2>::outBoundable;
      const bool outBoundP3 = p3IsAny && IsRef<T3>::outBoundable;
