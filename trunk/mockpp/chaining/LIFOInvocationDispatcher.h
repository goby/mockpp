/** @file
 ...
 $Id: LIFOInvocationDispatcher.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class LIFOInvocationDispatcher : public AbstractInvocationDispatcher<R, I>
{
  protected:
	 ...
	 typedef typename AbstractInvocationDispatcher<R, I>::ORT ORT; //!< internal shorthand
	 typedef typename ORT&  RRT;
