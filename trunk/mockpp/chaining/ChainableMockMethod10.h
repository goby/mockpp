/** @file
    @brief  Chainable Mock Method with 10 parameters.
            Generated with gen_chainablemethod_N.pl.

  $Id: ChainableMockMethod10.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ChainableMockMethod10_H
#define MOCKPP_ChainableMockMethod10_H
...
/** Common stuff to set up chainable mock method expectations with 10 parameters.
  * @ingroup grp_chainer
  * @internal
  */
...
class ChainableMockMethod10Common
  : public ChainableMockMethodCommon
  , public ChainingMockBuilder <ArgumentsMatchBuilder10<RT, Invocation10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> > >
{
  public:

    typedef Invocation10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>                InvocationType;  //!< internal shorthand
    ...
    typedef ChainingMockBuilder <ArgumentsMatchBuilder10<ReturnType, InvocationType> > Builder; //!< internal shorthand

  /** Constructs the mock object.
    * @param name    human readable description about the expectation
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod10Common(const String &name, ChainableMockObject *parent )
...
/** Set up a chainable mock method expectations with 10 parameters.
  * @ingroup grp_chainer
  */
template <typename RT, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10>
class ChainableMockMethod10
  : public ChainableMockMethod10Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod10Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::InvocationType   InvocationType;  //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::RRT   RRT;     //!< internal shorthand

	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT1   OT1;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT2   OT2;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT3   OT3;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT4   OT4;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT5   OT5;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT6   OT6;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT7   OT7;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT8   OT8;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT9   OT9;     //!< internal shorthand
	 typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::OT10   OT10;     //!< internal shorthand

  /** Constructs the mock object.
    * @param name    human readable description about the expectation
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod10(const String &name, ChainableMockObject *parent )
      : ChainableMockMethod10Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    */
    RRT forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4, const OT5 &p5, const OT6 &p6, const OT7 &p7, const OT8 &p8, const OT9 &p9, const OT10 &p10) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
      return this->getCoreMock().invoke(inv);
    }

	 RT operator () (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9, P10 p10) const
	 {
		return forward(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
	 }

    template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10>
    typename TypeTraits<R>::RefType anycall(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10) const
    {
      ...
      RRT r = forward(pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10);
...
class ChainableMockMethod10<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>
  : public ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::InvocationType   InvocationType;  //!< internal shorthand
  ...
  /** Constructs the mock object.
    ...
    */
    ChainableMockMethod10(const String &name, ChainableMockObject *parent )
      : ChainableMockMethod10Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p10 mock method parameter 10
    */
    void forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4, const OT5 &p5, const OT6 &p6, const OT7 &p7, const OT8 &p8, const OT9 &p9, const OT10 &p10) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
      this->getCoreMock().invoke(inv);
    }

	 void operator () (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9, P10 p10) const
	 {
		forward(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
	 }

    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10>
    void anycall(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9, T10 p10) const
    {
      const bool outBoundP1 = p1IsAny && IsRef<T1>::outBoundable;
      const bool outBoundP2 = p2IsAny && IsRef<T2>::outBoundable;
      const bool outBoundP3 = p3IsAny && IsRef<T3>::outBoundable;
      ...
      forward(pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10);
...
#endif // MOCKPP_ChainableMockMethod10_H
