/** @file
    @brief  Chainable Mock Method with 9 parameters.
            Generated with gen_chainablemethod_N.pl.

  $Id: ChainableMockMethod9.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ChainableMockMethod9_H
#define MOCKPP_ChainableMockMethod9_H
...
/** Common stuff to set up chainable mock method expectations with 9 parameters.
  * @ingroup grp_chainer
  * @internal
  */
...
class ChainableMockMethod9Common
  : public ChainableMockMethodCommon
  , public ChainingMockBuilder <ArgumentsMatchBuilder9<RT, Invocation9<P1, P2, P3, P4, P5, P6, P7, P8, P9> > >
{
  public:

    typedef Invocation9<P1, P2, P3, P4, P5, P6, P7, P8, P9>                InvocationType;  //!< internal shorthand
    ...
    typedef ChainingMockBuilder <ArgumentsMatchBuilder9<ReturnType, InvocationType> > Builder; //!< internal shorthand

  /** Constructs the mock object.
    * @param name    human readable description about the expectation
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod9Common(const String &name, ChainableMockObject *parent )
...
/** Set up a chainable mock method expectations with 9 parameters.
  * @ingroup grp_chainer
  */
template <typename RT, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9>
class ChainableMockMethod9
  : public ChainableMockMethod9Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod9Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9>::InvocationType   InvocationType;  //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9>::RRT   RRT;     //!< internal shorthand

	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT1   OT1;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT2   OT2;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT3   OT3;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT4   OT4;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT5   OT5;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT6   OT6;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT7   OT7;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT8   OT8;     //!< internal shorthand
	 typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::OT9   OT9;     //!< internal shorthand

  /** Constructs the mock object.
    * @param name    human readable description about the expectation
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod9(const String &name, ChainableMockObject *parent )
      : ChainableMockMethod9Common<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    */
    RRT forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4, const OT5 &p5, const OT6 &p6, const OT7 &p7, const OT8 &p8, const OT9 &p9) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4, p5, p6, p7, p8, p9);
      return this->getCoreMock().invoke(inv);
    }

	 RT operator () (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9) const
	 {
		return forward(p1, p2, p3, p4, p5, p6, p7, p8, p9);
	 }

    template <typename R, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
    typename TypeTraits<R>::RefType anycall(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9) const
    {
      ...
      RRT r = forward(pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9);
...
class ChainableMockMethod9<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>
  : public ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>
{
  ...
  public:
    ...
    typedef typename ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::InvocationType   InvocationType;  //!< internal shorthand
  ...
  /** Constructs the mock object.
    ...
    */
    ChainableMockMethod9(const String &name, ChainableMockObject *parent )
      : ChainableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p9 mock method parameter 9
    */
    void forward(const OT1 &p1, const OT2 &p2, const OT3 &p3, const OT4 &p4, const OT5 &p5, const OT6 &p6, const OT7 &p7, const OT8 &p8, const OT9 &p9) const
    {
      InvocationType inv(this->getMethodName(), p1, p2, p3, p4, p5, p6, p7, p8, p9);
      this->getCoreMock().invoke(inv);
    }

	 void operator () (P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7, P8 p8, P9 p9) const
	 {
		forward(p1, p2, p3, p4, p5, p6, p7, p8, p9);
	 }

    template <typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9>
    void anycall(T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9) const
    {
      const bool outBoundP1 = p1IsAny && IsRef<T1>::outBoundable;
      const bool outBoundP2 = p2IsAny && IsRef<T2>::outBoundable;
      const bool outBoundP3 = p3IsAny && IsRef<T3>::outBoundable;
      ...
      forward(pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9);
...
#endif // MOCKPP_ChainableMockMethod9_H
