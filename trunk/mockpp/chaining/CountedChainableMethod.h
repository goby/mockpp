/** @file
  ...
  $Id: CountedChainableMethod.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#include <mockpp/chaining/ChainableMockMethod7.h>
#include <mockpp/chaining/ChainableMockMethod8.h>
#include <mockpp/chaining/ChainableMockMethod9.h>
#include <mockpp/chaining/ChainableMockMethod10.h>
#include <mockpp/chaining/ChainableMockMethod11.h>
#include <mockpp/chaining/ChainableMockMethod12.h>
    ...
    */
    ...
    class Method
    {
      public:
        ...
        typedef ChainableMockMethod7<RT, P1, P2, P3, P4, P5, P6, P7> ChainableMockMethodType; //!< internal shorthand
    };
};
    ...
    */
    ...
    class Method
    {
      public:
        ...
        typedef ChainableMockMethod8<RT, P1, P2, P3, P4, P5, P6, P7, P8> ChainableMockMethodType; //!< internal shorthand
    };
};
    ...
    */
    ...
    class Method
    {
      public:
        ...
        typedef ChainableMockMethod9<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9> ChainableMockMethodType; //!< internal shorthand
    };
};
    ...
    */
    ...
    class Method
    {
      public:
        ...
        typedef ChainableMockMethod10<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> ChainableMockMethodType; //!< internal shorthand
    };
};
    ...
    */
    ...
    class Method
    {
      public:
        ...
        typedef ChainableMockMethod11<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11> ChainableMockMethodType; //!< internal shorthand
    };
};
    ...
    */
    ...
    class Method
    {
      public:
        ...
        typedef ChainableMockMethod12<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> ChainableMockMethodType; //!< internal shorthand
    };
};
...
class ChainableMockMethod
  : public SwitchChainable<CountParameters<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::value >
#ifdef MOCKPP_NO_TEMPLATE_HINT
             ::Method<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
#else
             ::template Method<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
#endif
  ...
  /** Constructs the mock object.
    ...
    */
    ChainableMockMethod(const String &name, ChainableMockObject *parent )
      : SwitchChainable<CountParameters<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::value >
#ifdef MOCKPP_NO_TEMPLATE_HINT
          ::Method<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
#else
          ::template Method<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
...
template<   typename RT
          ...
          , typename P11 = NoParameter
          , typename P12 = NoParameter
          , typename P13 = NoParameter> // one more parameter to enabled full specialisation
class ChainableMockMethod
{
};
...
/** Method mock class to select the actual class with 0 parameters.
  ...
  */
template<typename RT>
class ChainableMockMethod<RT, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod0<RT>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
...
class ChainableMockMethod<RT, P1, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod1<RT, P1>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
...
class ChainableMockMethod<RT, P1, P2, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod2<RT, P1, P2>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
...
class ChainableMockMethod<RT, P1, P2, P3, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod3<RT, P1, P2, P3>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
...
class ChainableMockMethod<RT, P1, P2, P3, P4, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod4<RT, P1, P2, P3, P4>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod5<RT, P1, P2, P3, P4, P5>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod6<RT, P1, P2, P3, P4, P5, P6>
{
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod7<RT, P1, P2, P3, P4, P5, P6, P7>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, NoParameter, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
      : ChainableMockMethod7<RT, P1, P2, P3, P4, P5, P6, P7>(name, parent)
    {
    }
};
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, NoParameter, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod8<RT, P1, P2, P3, P4, P5, P6, P7, P8>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, NoParameter, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
      : ChainableMockMethod8<RT, P1, P2, P3, P4, P5, P6, P7, P8>(name, parent)
    {
    }
};
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, NoParameter, NoParameter, NoParameter>
  : public ChainableMockMethod9<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, NoParameter, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
      : ChainableMockMethod9<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9>(name, parent)
    {
    }
};
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, NoParameter, NoParameter>
  : public ChainableMockMethod10<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, NoParameter, NoParameter>
          (const String &name, ChainableMockObject *parent )
      : ChainableMockMethod10<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(name, parent)
    {
    }
};
...
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, NoParameter>
  : public ChainableMockMethod11<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, NoParameter>
          (const String &name, ChainableMockObject *parent )
      : ChainableMockMethod11<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>(name, parent)
    {
    }
};
...
/** Method mock class to select the actual class with 12 parameters.
  * Works with partial specialisation.
  */
template<typename RT, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12>
class ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
  : public ChainableMockMethod12<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent chainable mock object
    */
    ChainableMockMethod<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
          (const String &name, ChainableMockObject *parent )
      : ChainableMockMethod12<RT, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>(name, parent)
    {
    }
};
