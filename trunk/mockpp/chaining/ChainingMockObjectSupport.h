/** @file
 ...
 $Id: ChainingMockObjectSupport.h 1424 2007-08-30 18:59:05Z ewald-arnold $
...
OUTBOUND( const T& op )
{
  return new OutBound<AnyType>( op );
}
...
typename TypelessStub<T>::AP returnValue( T o )
{
