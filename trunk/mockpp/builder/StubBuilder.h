/** @file
  ...
  $Id: StubBuilder.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
#include <mockpp/stub/ProcStubHelper.h>
  ...
  /** Sets the stub return data for the invocation.
    ...
    */
    IdentityBuilder& will( const StubHolder<R, I> &stubAction )
    {
	 ...
	 template <typename P>
	 IdentityBuilder& call(const P& p)
    {
		return will(invoke(&P::operator(), p));
    }
