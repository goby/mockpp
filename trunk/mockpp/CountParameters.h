/** @file
  ...
  $Id: CountParameters.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
class CountParameters
{
  public:
    ...
    { value =   CountIfUsed<P1>::value
              ...
              + CountIfUsed<P7>::value
              + CountIfUsed<P8>::value
              + CountIfUsed<P9>::value
              + CountIfUsed<P10>::value
              + CountIfUsed<P11>::value
              + CountIfUsed<P12>::value
    };
};
