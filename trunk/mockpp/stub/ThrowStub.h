/** @file
  ...
  $Id: ThrowStub.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class ThrowStub : public ThrowStubBase<R>
{
  public:
    ...
    typedef typename ThrowStubBase<R>::ORT    ORT;
    typedef typename ThrowStubBase<R>::RRT    RRT;
  ...
  /** Mock the invocation without passing parameters.
    ...
    */
    virtual RRT typelessInvoke()
    {
        ...
        return defaultValue;  // avoids warnings
    }
