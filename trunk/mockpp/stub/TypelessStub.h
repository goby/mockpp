/** @file
  ...
  $Id: TypelessStub.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class TypelessStub : public SelfDescribing
{
  public:
    ...
    typedef typename TypeTraits<R>::RefType          RRT; //!< internal shorthand
    typedef typename TypeTraits<R>::Type           ORT; //!< internal shorthand
    typedef typename TypeTraits<R>::RefType                Ref; //!< internal shorthand
    typedef typename TypeTraits<R>::Type                   RT; //!< internal shorthand
...
/** An object that stubs the behaviour of an invoked method invocation on behalf of an
  ...
  */
template <>  // Returntype
class TypelessStub<void> : public SelfDescribing
{
  public:

    typedef void     RT; //!< internal shorthand
    typedef void     RRT; //!< internal shorthand
    typedef void     ORT; //!< internal shorthand
    typedef void     CRRT; //!< internal shorthand
    typedef void     CORT; //!< internal shorthand

    typedef AutoPointer<TypelessStub<void> > AP;  //!< internal shared member
...
class TypelessStubAdapterBase : public Stub<R, I>
{
  public:
     ...
     typedef typename Stub<R, I>::RRT        RRT;
...
class TypelessStubAdapter : public TypelessStubAdapterBase<R, I>
{
  public:
     ...
     typedef typename TypelessStubAdapterBase<R, I>::RRT        RRT;
