/** @file
  ...
  $Id: ReturnStub.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class ReturnStub : public TypelessStub<R>
{
  public:
    ...
    typedef typename TypelessStub<R>::RRT   RRT; //!< internal shorthand
...
/** Always return the same specified value.
  ...
  */
template <typename R>  // Returntype
class ReturnStub<R&> : public TypelessStub<R&>
{
  public:
