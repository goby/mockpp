/** @file
    @brief  Visitable Mock Method with 9 parameters.
            Generated with gen_visitablemethod_N.pl.

  $Id: VisitableMockMethod9.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_VisitableMockMethod9_H
#define MOCKPP_VisitableMockMethod9_H

#include <mockpp/mockpp.h>

#include <mockpp/visiting/VisitableMockObject.h>
#include <mockpp/visiting/VisitableMockMethod.h>
#include <mockpp/visiting/ResponseVector9.h>


MOCKPP_NS_START


/** Common stuff to set up visitable mock method expectations with 9 parameters.
  * @ingroup grp_controller
  */
template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9>
class VisitableMockMethod9Common : public VisitableMockReturningMethodBase<R>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod9Common(const String &name, VisitableMockObject *parent)
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3, const ConstraintHolder<P4> &p4, const ConstraintHolder<P5> &p5, const ConstraintHolder<P6> &p6, const ConstraintHolder<P7> &p7, const ConstraintHolder<P8> &p8, const ConstraintHolder<P9> &p9) const
    {
  ...
  /** Perform the internals to verify a mocked method or setup expectations.
    ...
    * @param p9 mock method parameter 9
    */
    void forward_param(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9) const
    {
      ...
      else
      {
        try
        {
          ...
          Throwable *t;
          if (this->responseThrowables.find(t, p1, p2, p3, p4, p5, p6, p7, p8, p9))
             t->throw_me();
  ...
  /** Adds another response throwable.
    ...
    */
    void addResponseThrowable(Throwable *t, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, unsigned count = MOCKPP_UNLIMITED)
    {
      MOCKPP_ASSERT_FALSE(this->getVisitableMockObject()->isActivated());
      this->responseThrowables.add(t, p1, p2, p3, p4, p5, p6, p7, p8, p9, count);
    }
  ...
  private:
    ...
    mutable ResponseThrowableVector9<P1, P2, P3, P4, P5, P6, P7, P8, P9>   responseThrowables;
...
/** Set up visitable mock method expectations with 9 parameters.
  * @ingroup grp_controller
  */
template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9>
class VisitableMockMethod9
  : public VisitableMockMethod9Common<R, P1, P2, P3, P4, P5, P6, P7, P8, P9>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    * @param parent  parent Visitable mock object
    */
    VisitableMockMethod9(const String &name, VisitableMockObject *parent)
      : VisitableMockMethod9Common<R, P1, P2, P3, P4, P5, P6, P7, P8, P9>(name, parent)
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p9 mock method parameter 9
    */
    R forward(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9) const
    {
      this->forward_param(p1, p2, p3, p4, p5, p6, p7, p8, p9);

      if (this->getVisitableMockObject()->isActivated() )
      {
        R ret_val;
        if (this->responseValues.find(ret_val, p1, p2, p3, p4, p5, p6, p7, p8, p9))
          return ret_val;
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3, const ConstraintHolder<P4> &p4, const ConstraintHolder<P5> &p5, const ConstraintHolder<P6> &p6, const ConstraintHolder<P7> &p7, const ConstraintHolder<P8> &p8, const ConstraintHolder<P9> &p9) const
    {
       VisitableMockMethod9Common<R, P1, P2, P3, P4, P5, P6, P7, P8, P9>::forward(p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
#else
    using VisitableMockMethod9Common<R, P1, P2, P3, P4, P5, P6, P7, P8, P9>::forward;
#endif
  ...
  /** Adds another response value.
    ...
    * @param count   the number of times this value shall be returned. Default is unlimited.
    */
    void addResponseValue(const R &rv, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, unsigned count = MOCKPP_UNLIMITED)
    {
      MOCKPP_ASSERT_FALSE(this->getVisitableMockObject()->isActivated());
      this->responseValues.add(rv, p1, p2, p3, p4, p5, p6, p7, p8, p9, count);
    }
  ...
  private:
    ...
    mutable ResponseVector9<R, P1, P2, P3, P4, P5, P6, P7, P8, P9>   responseValues;
};
...
class VisitableMockMethod9<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>
   : public VisitableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>
{
  public:
  ...
  /** Constructs the mock object.
    ...
    */
    VisitableMockMethod9(const String &name, VisitableMockObject *parent)
      : VisitableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>(name, parent)
    {
    }
  ...
  /** Actually verifies the mocked method.
    ...
    * @param p9 mock method parameter 9
    */
    void forward(const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9) const
    {
       this->forward_param(p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
  ...
  /** Set up expectations with constraints.
    ...
    */
    void forward (const ConstraintHolder<P1> &p1, const ConstraintHolder<P2> &p2, const ConstraintHolder<P3> &p3, const ConstraintHolder<P4> &p4, const ConstraintHolder<P5> &p5, const ConstraintHolder<P6> &p6, const ConstraintHolder<P7> &p7, const ConstraintHolder<P8> &p8, const ConstraintHolder<P9> &p9) const
    {
       VisitableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::forward(p1, p2, p3, p4, p5, p6, p7, p8, p9);
    }
#else
    using VisitableMockMethod9Common<void, P1, P2, P3, P4, P5, P6, P7, P8, P9>::forward;
#endif
};
...
#endif // MOCKPP_VisitableMockMethod9_H
