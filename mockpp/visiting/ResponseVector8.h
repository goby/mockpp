/** @file
  ...
  $Id: ResponseVector8.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ResponseVector8_H
#define MOCKPP_ResponseVector8_H
...
class ResponseThrowableVector8 : public ResponseVectorBase
{
  public:
  ...
  /**
    ...
    */
    ResponseThrowableVector8(const String &aName, VerifiableList *parent)
      : ResponseVectorBase(aName, parent)
    {}

  /** Destroys the vector
    */
    virtual ~ResponseThrowableVector8()
    {
      reset();
    }
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, unsigned count)
    {
      ...
      add(throwable, h1, h2, h3, h4, h5, h6, h7, h8, count);
    }
  ...
  /** Finds a throwable for a set of parameters.
    ...
    */
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8)
    {
...
class ResponseVector8  : public ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>
{
  public:
  ...
  /** Construct a new empty vector
    ...
    * @param parent  parent verifiable
    */
    ResponseVector8(const String &aName, VerifiableList *parent)
      : ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>(aName, parent)
    {}
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, unsigned count)
    {
      ...
      ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>::add(throwable, p1, p2, p3, p4, p5, p6, p7, p8, count);
      R r;
      rvec.push_back(r);
    }
  ...
  /** Adds a return value.
    ...
    * @param count  the number of times the object may be used
    */
    void add(const R &r, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, unsigned count)
    {
      ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>::add((Throwable*)0, p1, p2, p3, p4, p5, p6, p7, p8, count);
      rvec.push_back(r);
    }
  ...
  /** Removes all the objects from the list.
    */
    void reset()
    {
      ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>::reset();
      rvec.clear();
    }
    ...
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8)
    {
      return ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>::find(throwable, p1, p2, p3, p4, p5, p6, p7, p8);
    }
#else
    using ResponseThrowableVector8<P1, P2, P3, P4, P5, P6, P7, P8>::find;
#endif
  ...
  /** Finds a return value for a set of parameters.
    ...
    */
    bool find(R &r, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8)
    {
...
#endif // MOCKPP_ResponseVector8_H
