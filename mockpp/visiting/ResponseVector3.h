/** @file
  ...
  $Id: ResponseVector3.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ResponseVector3_H
#define MOCKPP_ResponseVector3_H
...
class ResponseThrowableVector3 : public ResponseVectorBase
{
  ...
  /** Destroys the vector
    */
    virtual ~ResponseThrowableVector3()
    {
      reset();
    }
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, unsigned count)
    {
  ...
  /** Finds a throwable for a set of parameters.
    ...
    */
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3)
    {
...
class ResponseVector3  : public ResponseThrowableVector3<P1, P2, P3>
{
  public:
  ...
  /** Construct a new empty vector
    ...
    */
    ResponseVector3(const String &aName, VerifiableList *parent)
      : ResponseThrowableVector3<P1, P2, P3>(aName, parent)
    {}
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, unsigned count)
    {
      ...
      ResponseThrowableVector3<P1, P2, P3>::add(throwable, p1, p2, p3, count);
      R r;
      rvec.push_back(r);
    }
  ...
  /** Adds a return value.
    ...
    * @param count  the number of times the object may be used
    */
    void add(const R &r, const P1 &p1, const P2 &p2, const P3 &p3, unsigned count)
    {
      ResponseThrowableVector3<P1, P2, P3>::add((Throwable*)0, p1, p2, p3, count);
      rvec.push_back(r);
    }
  ...
  /** Removes all the objects from the list.
    */
    void reset()
    {
      ResponseThrowableVector3<P1, P2, P3>::reset();
      rvec.clear();
    }
    ...
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3)
    {
      return ResponseThrowableVector3<P1, P2, P3>::find(throwable, p1, p2, p3);
    }
#else
    using ResponseThrowableVector3<P1, P2, P3>::find;
#endif
  ...
  /** Finds a return value for a set of parameters.
    ...
    */
    bool find(R &r, const P1 &p1, const P2 &p2, const P3 &p3)
    {
...
#endif // MOCKPP_ResponseVector3_H
