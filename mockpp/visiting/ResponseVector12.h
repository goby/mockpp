/** @file
  ...
  $Id: ResponseVector12.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ResponseVector12_H
#define MOCKPP_ResponseVector12_H
...
class ResponseThrowableVector12 : public ResponseVectorBase
{
  public:
  ...
  /**
    ...
    */
    ResponseThrowableVector12(const String &aName, VerifiableList *parent)
      : ResponseVectorBase(aName, parent)
    {}

  /** Destroys the vector
    */
    virtual ~ResponseThrowableVector12()
    {
      reset();
    }
  ...
  /** Adds a throwable.
    ...
    * @param p10     the parameter 10 upon which to return
    * @param p11     the parameter 11 upon which to return
    * @param p12     the parameter 12 upon which to return
    * @param count  the number of times the object may be used
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, const P11 &p11, const P12 &p12, unsigned count)
    {
      ...
      const ConstraintHolder<P10> h10 = new IsEqual<P10>(p10);
      const ConstraintHolder<P11> h11 = new IsEqual<P11>(p11);
      const ConstraintHolder<P12> h12 = new IsEqual<P12>(p12);
      add(throwable, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, h11, h12, count);
    }
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable,
             ...
             const ConstraintHolder<P10> &p10,
             const ConstraintHolder<P11> &p11,
             const ConstraintHolder<P12> &p12,
             unsigned count)
    {
      ...
      typename MOCKPP_NS::Constraint<P10>::AP cons10 (p10);
      typename MOCKPP_NS::Constraint<P11>::AP cons11 (p11);
      typename MOCKPP_NS::Constraint<P12>::AP cons12 (p12);
      ...
      t10vec.push_back(cons10.release());
      t11vec.push_back(cons11.release());
      t12vec.push_back(cons12.release());
    }
  ...
  /** Removes all the objects from the list.
    */
    void reset()
    {
      ...
      for (unsigned i10 = 0; i10 < t10vec.size(); ++i10)
        delete t10vec[i10];
      t10vec.clear();

      for (unsigned i11 = 0; i11 < t11vec.size(); ++i11)
        delete t11vec[i11];
      t11vec.clear();

      for (unsigned i12 = 0; i12 < t12vec.size(); ++i12)
        delete t12vec[i12];
      t12vec.clear();
    }
  ...
  /** Finds a throwable for a set of parameters.
    ...
    */
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, const P11 &p11, const P12 &p12)
    {
  ...
  protected:
    ...
    MOCKPP_STL::vector<Constraint<P10>*>       t10vec; //!< shared internal member
    MOCKPP_STL::vector<Constraint<P11>*>       t11vec; //!< shared internal member
    MOCKPP_STL::vector<Constraint<P12>*>       t12vec; //!< shared internal member
};
...
class ResponseVector12  : public ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>
{
  public:
  ...
  /** Construct a new empty vector
    ...
    * @param parent  parent verifiable
    */
    ResponseVector12(const String &aName, VerifiableList *parent)
      : ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>(aName, parent)
    {}
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, const P11 &p11, const P12 &p12, unsigned count)
    {
      ...
      ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::add(throwable, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, count);
      R r;
      rvec.push_back(r);
    }
  ...
  /** Adds a return value.
    ...
    * @param count  the number of times the object may be used
    */
    void add(const R &r, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, const P11 &p11, const P12 &p12, unsigned count)
    {
      ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::add((Throwable*)0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, count);
      rvec.push_back(r);
    }
  ...
  /** Removes all the objects from the list.
    */
    void reset()
    {
      ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::reset();
      rvec.clear();
    }
    ...
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, const P11 &p11, const P12 &p12)
    {
      return ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::find(throwable, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
    }
#else
    using ResponseThrowableVector12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>::find;
#endif
  ...
  /** Finds a return value for a set of parameters.
    ...
    */
    bool find(R &r, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, const P11 &p11, const P12 &p12)
    {
       for (unsigned i = 0; i < this->t1vec.size(); ++i)
         if (   this->counter[i] > 0
             ...
             && this->t10vec[i]->eval(p10)
             && this->t11vec[i]->eval(p11)
             && this->t12vec[i]->eval(p12)
            )
         {
           if (this->tvec.at(i) != 0)
             return false;
...
#endif // MOCKPP_ResponseVector12_H
