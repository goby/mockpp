/** @file
  ...
  $Id: ResponseVector10.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
#ifndef MOCKPP_ResponseVector10_H
#define MOCKPP_ResponseVector10_H
...
class ResponseThrowableVector10 : public ResponseVectorBase
{
  public:
  ...
  /**
    ...
    */
    ResponseThrowableVector10(const String &aName, VerifiableList *parent)
      : ResponseVectorBase(aName, parent)
    {}

  /** Destroys the vector
    */
    virtual ~ResponseThrowableVector10()
    {
      reset();
    }
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, unsigned count)
    {
      ...
      add(throwable, h1, h2, h3, h4, h5, h6, h7, h8, h9, h10, count);
    }
  ...
  /** Finds a throwable for a set of parameters.
    ...
    */
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10)
    {
...
class ResponseVector10  : public ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>
{
  public:
  ...
  /** Construct a new empty vector
    ...
    * @param parent  parent verifiable
    */
    ResponseVector10(const String &aName, VerifiableList *parent)
      : ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>(aName, parent)
    {}
  ...
  /** Adds a throwable.
    ...
    */
    void add(Throwable *throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, unsigned count)
    {
      ...
      ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::add(throwable, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, count);
      R r;
      rvec.push_back(r);
    }
  ...
  /** Adds a return value.
    ...
    * @param count  the number of times the object may be used
    */
    void add(const R &r, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10, unsigned count)
    {
      ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::add((Throwable*)0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, count);
      rvec.push_back(r);
    }
  ...
  /** Removes all the objects from the list.
    */
    void reset()
    {
      ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::reset();
      rvec.clear();
    }
    ...
    bool find(Throwable * &throwable, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10)
    {
      return ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::find(throwable, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
    }
#else
    using ResponseThrowableVector10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>::find;
#endif
  ...
  /** Finds a return value for a set of parameters.
    ...
    */
    bool find(R &r, const P1 &p1, const P2 &p2, const P3 &p3, const P4 &p4, const P5 &p5, const P6 &p6, const P7 &p7, const P8 &p8, const P9 &p9, const P10 &p10)
    {
...
#endif // MOCKPP_ResponseVector10_H
