/** @file
    @brief  Checks the occurrence of a substring

  $Id: StringContains.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
#ifndef MOCKPP_STRINGCONTAINS_H
#define MOCKPP_STRINGCONTAINS_H
...
class StringContains : public Constraint<StringType>
{
  public:
  ...
  /** Evaluates the constraint
    ...
    */
    ...
    {
        return o.find(substring) != StringType::npos;
    }
  ...
  /** Appends the description of this object to the buffer.
    ...
    */
    ...
    {
        buffer += MOCKPP_PCHAR("a string containing \"")
