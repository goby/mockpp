/** @file
 ...
 $Id: InvocationMockerBuilder.h 1286 2007-02-27 20:21:02Z ewald-arnold $
...
class InvocationMockerBuilder : public AMB
{
    ...
    typedef typename TypeTraits<R>::OriginalType  ORT;
    typedef typename TypeTraits<R>::ReferenceType RRT;
