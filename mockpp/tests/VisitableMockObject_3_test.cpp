/***************************************************************************
  ...
  $Id: VisitableMockObject_3_test.cpp 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class VisitableMockObject_3_test MOCKPP_DERIVE_PUBLIC_UNITFRAMEWORK
{
 public:
...
MOCKPP_CXXTEST_SUITE_REGISTRATION( VisitableMockObject_3_test );

MOCKPP_CXXTEST(VisitableMockObject_3_test, test_controller);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_thrower);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_parameter);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_parameter_ex);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_response);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_return);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_clear);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_default_throw);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_inline_pre_1_2);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_inline_post_1_2);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_constraint);
MOCKPP_CXXTEST(VisitableMockObject_3_test, test_controller_constraint);

MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_add_throw_after_active);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_add_throw_val_after_active);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_set_throw_after_active);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_add_method_after_active);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_add_return_after_active);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_set_return_after_active);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_parameter);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_return);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_unused_throwable);
MOCKPP_CXXTEST(VisitableMockObject_3_test, fail_unused_value);

#elif defined(MOCKPP_USE_BOOSTTEST)

MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_controller);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_thrower);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_parameter);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_parameter_ex);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_response);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_return);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_clear);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_default_throw);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_inline_pre_1_2);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_inline_post_1_2);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_constraint);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::test_controller_constraint);

MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_add_throw_after_active);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_add_throw_val_after_active);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_set_throw_after_active);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_add_method_after_active);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_add_return_after_active);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_set_return_after_active);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_parameter);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_return);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_unused_throwable);
MOCKPP_BOOST_TEST(VisitableMockObject_3_test::fail_unused_value);
...
class MyVisitableMockObject_3 : public MOCKPP_NS::VisitableMockObject
{
  public:

    MyVisitableMockObject_3(const MOCKPP_NS::String &name)
      : MOCKPP_NS::VisitableMockObject(name, 0),
        MOCKPP_CONSTRUCT_MEMBERS_FOR_VISITABLE3(visitable)
    {}
...
class MyVisitableMockObject_3ex : public MOCKPP_NS::VisitableMockObject
{
  public:

    MyVisitableMockObject_3ex(const MOCKPP_NS::String &name)
      : MOCKPP_NS::VisitableMockObject(name, 0),
    ...
    MOCKPP_VISITABLE_EXT3(MyVisitableMockObject_3ex, const MOCKPP_STL::string, visitable3, const MOCKPP_STL::string &, const MOCKPP_STL::string &, const MOCKPP_STL::string &,
                                                     MOCKPP_STL::string,       Ext,        MOCKPP_STL::string,         MOCKPP_STL::string,         MOCKPP_STL::string);

    MOCKPP_VISITABLE_EXT2(MyVisitableMockObject_3ex, const MOCKPP_STL::string, visitable2, const MOCKPP_STL::string &, const MOCKPP_STL::string &,
                                                     MOCKPP_STL::string,       Ext,        MOCKPP_STL::string,         MOCKPP_STL::string);

    MOCKPP_VISITABLE_EXT1(MyVisitableMockObject_3ex, const MOCKPP_STL::string, visitable1, const MOCKPP_STL::string &,
                                                     MOCKPP_STL::string,       Ext,        MOCKPP_STL::string);

    MOCKPP_VISITABLE_EXT0(MyVisitableMockObject_3ex, const MOCKPP_STL::string, visitable0,
                                                     MOCKPP_STL::string,       Ext);

    bool isClear()
    {
      return    visitable3ExtDefaultThrowable.get() == 0  // check preprocessed doc-template.h for the actual members
             && visitable3ExtThrowables.size() == 0

             && visitable3ExtResponseValues.size() == 0
             && visitable3ExtParameter1.size() == 0
             && visitable3ExtParameter2.size() == 0
             && visitable3ExtParameter3.size() == 0

             && visitable3ExthaveDefaultReturnValue == false
             && visitable3ExtDefaultReturnValueUsed == false
             && visitable3ExtReturnValues.hasMoreObjects() == false;
    }
};
...
{
  MyVisitableMockObject_3 mvo(MOCKPP_PCHAR("mvo"));
  ...
  ctr.addResponseThrowable(MOCKPP_NS::make_throwable(int(1)), 0, 2, 3);
  ctr.addResponseThrowable(MOCKPP_NS::make_throwable(int(0)), 1, 2, 3);
}
...
void VisitableMockObject_3_test::test_thrower()
{
  ...
  MOCKPP_ASSERT_THROWING(mvo.visitable(1, 2, 3), MOCKPP_PCSTRING("1"),
                         MOCKPP_STL::string, "exceptional string 1");

  MOCKPP_ASSERT_THROWING(mvo.visitable(1, 2, 3), MOCKPP_PCSTRING("2"),
                         MOCKPP_STL::string, "exceptional string 2");

  MOCKPP_ASSERT_THROWING(mvo.visitable(1, 2, 3), MOCKPP_PCSTRING("3"),
                         MOCKPP_STL::string, "exceptional string 2");

  MOCKPP_ASSERT_THROWING(mvo.visitable(1, 2, 3), MOCKPP_PCSTRING("4"),
...
void VisitableMockObject_3_test::fail_return()
{
  ...
  MOCKPP_ASSERT_TRUE(1 == mvo.visitable(1, 2, 3));
  MOCKPP_ASSERT_TRUE(11 == mvo.visitable(2, 2, 3));
  bool thrown = false;
  MOCKPP_TRY
  {
    mvo.visitable(3, 2, 3);
...
void VisitableMockObject_3_test::test_return()
{
  ...
  MOCKPP_ASSERT_TRUE(11 == mvo.visitable(2, 2, 3));
  MOCKPP_ASSERT_TRUE(11 == mvo.visitable(2, 2, 3));
  MOCKPP_ASSERT_TRUE(123 == mvo.visitable(3, 2, 3));
  MOCKPP_ASSERT_TRUE(123 == mvo.visitable(4, 2, 3));
  mvo.verify();
}


void VisitableMockObject_3_test::test_parameter_ex()
{
  MyVisitableMockObject_3ex mvo(MOCKPP_PCHAR("mvo"));
  MOCKPP_ASSERT_TRUE(mvo.isClear() == true);

  MOCKPP_CONTROLLER_FOR_EXT(MyVisitableMockObject_3ex, visitable3, Ext) ctr3 (&mvo);
  ctr3.setDefaultReturnValue("3");

  MOCKPP_CONTROLLER_FOR_EXT(MyVisitableMockObject_3ex, visitable2, Ext) ctr2 (&mvo);
  ctr2.setDefaultReturnValue("2");

  MOCKPP_CONTROLLER_FOR_EXT(MyVisitableMockObject_3ex, visitable1, Ext) ctr1 (&mvo);
  ctr1.setDefaultReturnValue("1");

  MOCKPP_CONTROLLER_FOR_EXT(MyVisitableMockObject_3ex, visitable0, Ext) ctr0 (&mvo);
...
void VisitableMockObject_3_test::test_default_throw()
{
  MyVisitableMockObject_3 mvo(MOCKPP_PCHAR("mvo"));
  MOCKPP_CONTROLLER_FOR(MyVisitableMockObject_3, visitable) ctr (&mvo);
  ctr.addResponseThrowable(MOCKPP_NS::make_throwable(MOCKPP_STL::string("throw me 2")), 922, 2, 3);
  ctr.addResponseThrowable(MOCKPP_NS::make_throwable(MOCKPP_STL::string("throw me 1")), 911, 2, 3);
...
#ifndef MOCKPP_NO_EXCEPTIONS
  MOCKPP_ASSERT_THROWING(mvo.visitable(922, 2, 3), MOCKPP_PCHAR("response 1"),
                         MOCKPP_STL::string, MOCKPP_STL::string("throw me 2"));

  MOCKPP_ASSERT_THROWING(mvo.visitable(911, 2, 3), MOCKPP_PCHAR("response 2"),
                         MOCKPP_STL::string, MOCKPP_STL::string("throw me 1"));

  MOCKPP_ASSERT_THROWING(mvo.visitable(1, 2, 3), MOCKPP_PCHAR("default response"),
                         MOCKPP_STL::string, MOCKPP_STL::string("throw default"));

  MOCKPP_ASSERT_THROWING(mvo.visitable(2, 2, 3), MOCKPP_PCHAR("default response"),
                         MOCKPP_STL::string, MOCKPP_STL::string("throw default"));
#endif
}
...
void VisitableMockObject_3_test::test_response()
{
  ...
  MOCKPP_ASSERT_TRUE(123 == mvo.visitable(456, 2, 3));
  MOCKPP_ASSERT_TRUE(321 == mvo.visitable(654, 2, 3));
  MOCKPP_ASSERT_TRUE(111 == mvo.visitable(1, 2, 3));
  ...
  MOCKPP_ASSERT_TRUE(111 == mvo.visitable(2, 2, 3));
  MOCKPP_ASSERT_TRUE(111 == mvo.visitable(3, 2, 3));
...
void VisitableMockObject_3_test::test_inline_pre_1_2()
{
  MyVisitableMockObject_3 mvo(MOCKPP_PCHAR("mvo"));
  MOCKPP_CONTROLLER_FOR(MyVisitableMockObject_3, visitable) ctr (&mvo);
  ...
  MOCKPP_ASSERT_TRUE(111 == mvo.visitable(1, 2, 3));
  MOCKPP_ASSERT_TRUE(222 == mvo.visitable(1, 2, 3));

  mvo.verify();
}


void VisitableMockObject_3_test::test_inline_post_1_2()
{
  MyVisitableMockObject_3 mvo(MOCKPP_PCHAR("mvo"));
  MOCKPP_CONTROLLER_FOR(MyVisitableMockObject_3, visitable) ctr (&mvo);
  ctr.addReturnValue(111);
...
void VisitableMockObject_3_test::test_constraint()
{
  MyVisitableMockObject_3 mvo(MOCKPP_PCHAR("mvo"));
  MOCKPP_CONTROLLER_FOR(MyVisitableMockObject_3, visitable) ctr (&mvo);
  ctr.setDefaultReturnValue(123);
  ...
  mvo.activate();
  mvo.visitable(12, 34, 90);
  mvo.verify();
}


void VisitableMockObject_3_test::test_controller_constraint()
{
  MyVisitableMockObject_3 mvo(MOCKPP_PCHAR("mvo"));
  MOCKPP_CONTROLLER_FOR(MyVisitableMockObject_3, visitable) ctr (&mvo);
  ctr.setDefaultReturnValue(123);
  ...
  mvo.activate();
  MOCKPP_ASSERT_TRUE(1 == mvo.visitable(11, 21, 51));
  MOCKPP_ASSERT_TRUE(2 == mvo.visitable(9, 19, 49));

#ifndef MOCKPP_NO_EXCEPTIONS
  MOCKPP_ASSERT_THROWING(mvo.visitable(8, 18, 48),
                         MOCKPP_PCHAR("mvo.visitable(8, 18, 48)"),
                         int,
                         2);

  MOCKPP_ASSERT_THROWING(mvo.visitable(12, 22, 52),
                         MOCKPP_PCHAR("mvo.visitable(12, 22, 52)"),
                         int,
                         1);
#endif

  MOCKPP_ASSERT_TRUE(123 == mvo.visitable(1, 1, 1));
  mvo.verify();
}
