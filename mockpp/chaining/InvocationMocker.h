...
$Id: InvocationMocker.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class InvocationMocker : public InvocationMockerBase<R, I>
{
  ...
  public:
    ...
    typedef typename InvocationMockerBase<R, I>::DefaultDescriber DefaultDescriber;   //!< internal shorthand
	 ...
	 typedef typename InvocationMockerBase<R, I>::ORT   ORT;
	 typedef typename InvocationMockerBase<R, I>::RRT   RRT;
