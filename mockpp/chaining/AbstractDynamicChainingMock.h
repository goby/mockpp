...
$Id: AbstractDynamicChainingMock.h 1254 2007-01-01 16:46:44Z ewald-arnold $
...
class AbstractDynamicChainingMockImpl : public DynamicChainingMock<R, I>
{
  ...
  public:
	...
	typedef typename DynamicChainingMock<R, I>::ORT ORT;
	typedef typename DynamicChainingMock<R, I>::RRT RRT;
  ...
  /** Mocks an invocation
    ...
    */
    virtual RRT mockInvocation( const I &invocation ) = 0;
...
class AbstractDynamicChainingMock : public AbstractDynamicChainingMockImpl<R, I>
{
  public:
    ...
    typedef typename AbstractDynamicChainingMockImpl<R, I>::ORT   ORT;
    typedef typename AbstractDynamicChainingMockImpl<R, I>::RRT   RRT;
  ...
  /** Mocks an invocation
    ...
    * @return  the mocked return value
    */
    virtual RRT mockInvocation( const I &invocation )
    {
