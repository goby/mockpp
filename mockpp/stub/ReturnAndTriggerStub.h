/** @file
  ...
  $Id: ReturnAndTriggerStub.h,v 1.7 2005/10/19 20:53:09 ewald-arnold Exp $
...
class ReturnAndTriggerStub1 : public TypelessStub<R>
{
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub1(  const ORT &in_result
...
class ReturnAndTriggerStub2 : public TypelessStub<R>
{
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub2(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
...
class ReturnAndTriggerStub3 : public TypelessStub<R>
{
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub3(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
...
class ReturnAndTriggerStub4 : public TypelessStub<R>
{
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub4(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
...
class ReturnAndTriggerStub5 : public TypelessStub<R>
{
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub5(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
class ReturnAndTriggerStub6 : public TypelessStub<R>
{
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub6(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
template <  typename R     // Returntype
         ...
         >
class ReturnAndTriggerStub7 : public TypelessStub<R>
{
  public:
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub7(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
template <  typename R     // Returntype
         ...
         >
class ReturnAndTriggerStub8 : public TypelessStub<R>
{
  public:
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub8(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
template <  typename R     // Returntype
         ...
         >
class ReturnAndTriggerStub9 : public TypelessStub<R>
{
  public:
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub9(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
template <  typename R     // Returntype
         ...
         >
class ReturnAndTriggerStub10 : public TypelessStub<R>
{
  public:
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub10(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
template <  typename R     // Returntype
         ...
         >
class ReturnAndTriggerStub11 : public TypelessStub<R>
{
  public:
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub11(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
...
template <  typename R     // Returntype
         ...
         >
class ReturnAndTriggerStub12 : public TypelessStub<R>
{
  public:
  ...
  /** Creates the object.
    ...
    */
    ReturnAndTriggerStub12(  const ORT &in_result
                          , TriggeredConstraint<T1> *in_tc1
                          , TriggeredConstraint<T2> *in_tc2
                          , TriggeredConstraint<T3> *in_tc3
                          , TriggeredConstraint<T4> *in_tc4
